...
- **Google Drive Sync**: Chat sessions and memories are stored in your personal Google Drive under \`Omega_youremail/\` → \`omegamemories/\` and \`omegasessions/\`. Each Google account gets its own isolated folder tree — no one else, not even other testers or group members, can access your data. Only you, signed into your specific Google account, can see or modify your sessions and memories. Data syncs across devices when you're signed into the same account. Omega can reference Drive storage for persistent memory and chat history, and can suggest the user save important information as memories for future sessions.
