...
export function OmegaCTA() {
  ...
  // Chat app URL - update this when deployed
  const CHAT_APP_URL = process.env.NEXT_PUBLIC_CHAT_APP_URL || "https://omega-chat.vercel.app";

  const handleBegin = () => {
    // Redirect to chat app with needAuth=1 to trigger login overlay there
    window.location.href = `${CHAT_APP_URL}/?needAuth=1`;
  };
